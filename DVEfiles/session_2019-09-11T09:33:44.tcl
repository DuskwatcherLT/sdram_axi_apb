...
# DVE full session
# Saved on Wed Sep 11 09:33:44 2019
# Designs open: 1
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 445} {child_wave_right 1085} {child_wave_colname 220} {child_wave_colvalue 220} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_load_child_values {ddr_system.u_sdram.u_axi}
...
gui_wv_zoom_timerange -id ${Wave.1} 0 1454080
gui_list_add_group -id ${Wave.1} -after {New Group} {Group1}
gui_list_select -id ${Wave.1} {ddr_system.u_sdram.u_axi.axi_awready_o }
