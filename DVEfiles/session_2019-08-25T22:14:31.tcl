...
# DVE reload session
# Saved on Sun Aug 25 22:14:31 2019
# Designs open: 1
...
# MDI window settings
set Wave.1 Wave.1
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 479} {child_wave_right 1167} {child_wave_colname 237} {child_wave_colvalue 238} {child_wave_col1 0} {child_wave_col2 1}}
...
# Restore C1 time
gui_set_time -C1_only 634063120
...
gui_list_set_filter -id ${Data.1} -text {refresh_q}
...
gui_wv_zoom_timerange -id ${Wave.1} 634063120 634063844.993
...
gui_marker_move -id ${Wave.1} {C1} 600
